                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <a href="Pictures/img_1.jpg" class="fh5co-card-item image-popup">
                        ...
                        <div class="fh5co-text">
                            <input type="hidden" ><%=b.getId()%></input>
                         ...
                         <%--  <a href="EditTrip.jsp?id=<%=b.getId()%>" class="btn btn-sm btn-primary">
                                <i class="fas fa-edit"></i> Düzenle</a>--%>
<%--                          <a href="../deleteTrip?id=<%=b.getId()%>" class="btn btn-sm btn-danger">
                                <i class="fas fa-trash-alt"></i> Sil</a>--%>

                            <a href="delete?id=<%=b.getId()%>" class="btn btn-sm btn-danger">
                                <i class="fas fa-trash-alt"></i> Sil</a>
                        </div>
                    </a>
                </div>
